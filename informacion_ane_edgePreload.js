...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "informacion_ane_edge.js"},
      { load: "informacion_ane_edgeActions.js"}];
...
var plSTF="both",ctrPlS="both",minPlW="0",maxPlW=undefined,plWidth="1024px",plHeight="640px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['452', '260','120px','120px','auto', 'auto'],
